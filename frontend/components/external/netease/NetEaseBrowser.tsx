...
import { NetEaseDiscoverTab } from './NetEaseDiscoverTab';
import { NetEaseSearchTab } from './NetEaseSearchTab';
import { NetEaseToolsTab } from './NetEaseToolsTab';

export function NetEaseBrowser({ cookie, userId, onLogout }: { cookie: string, userId: string, onLogout: () => void }) {
      ...
      <div className="flex-1 min-h-0 border rounded-md">
        <Tabs defaultValue="created" className="h-full flex flex-col">
            ...
            <div className="flex-1 min-h-0">
                ...
                <TabsContent value="discover" className="m-0 mt-0 h-full">
                    <NetEaseDiscoverTab cookie={cookie} onPlaylistClick={handlePlaylistClick} />
                </TabsContent>
                ...
                <TabsContent value="tools" className="m-0 mt-0 h-full">
                    <NetEaseToolsTab cookie={cookie} onPlaylistClick={handlePlaylistClick} />
                </TabsContent>
            </div>
        </Tabs>
      </div>
